...
import it.mirea.pizzeria.databinding.ItemPermPizzaListBinding;
import it.mirea.pizzeria.databinding.ItemPizzaListBinding;

public class PizzaPermAdapter extends RecyclerView.Adapter<PizzaPermAdapter.PizzaViewHolder>{
    ...
    public PizzaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemPermPizzaListBinding binding = ItemPermPizzaListBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    ...
    public static class PizzaViewHolder extends RecyclerView.ViewHolder {
        ...
        ItemPermPizzaListBinding binding;

        TextView nameTxt,pizzaTxt,receptTxt,time;


        public PizzaViewHolder(ItemPermPizzaListBinding binding){
